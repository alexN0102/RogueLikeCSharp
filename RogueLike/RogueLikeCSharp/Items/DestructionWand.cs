...
namespace RogueSharpRLNetSamples.Items
{
    public class DestructionWand : Item
    {
        ...
        protected override bool UseItem()
        {
            ...
            RogueSharp.Point edgePoint = GetRandomEdgePoint(map);
        ...
        private RogueSharp.Point GetRandomEdgePoint(DungeonMap map)
        {
            ...
            switch (result)
            {
                case 1: // TOP
                    {
                        return new RogueSharp.Point(random.Next(3, map.Width - 3), 3);
                    }
                case 2: // BOTTOM
                    {
                        return new RogueSharp.Point(random.Next(3, map.Width - 3), map.Height - 3);
                    }
                case 3: // RIGHT
                    {
                        return new RogueSharp.Point(map.Width - 3, random.Next(3, map.Height - 3));
                    }
                case 4: // LEFT
                    {
                        return new RogueSharp.Point(3, random.Next(3, map.Height - 3));
                    }
                default:
                    {
                        return new RogueSharp.Point(3, 3);
                    }
            }
        }
    }
