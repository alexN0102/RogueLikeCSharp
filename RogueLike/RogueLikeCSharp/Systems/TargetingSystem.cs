...
namespace RogueSharpRLNetSamples.Systems
{
    public class TargetingSystem
    {
        ...
        private RogueSharp.Point _cursorPosition;
        private List<RogueSharp.Point> _selectableTargets = new List<RogueSharp.Point>();
        ...
        public bool SelectArea(ITargetable targetable, int area = 0)
        {
            ...
            _cursorPosition = new RogueSharp.Point { X = player.X, Y = player.Y };
            _targetable = targetable;
            _area = area;
        ...
        private void Initialize()
        {
            ...
            _selectableTargets = new List<RogueSharp.Point>();
